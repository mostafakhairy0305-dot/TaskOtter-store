# Bruno Taskfile (npm-nvm) Public Tasks
...
dev dependency This variant uses the `npm-nvm` stack (`npm-nvm`) package manager.
...
includes:
  ...
  bruno:
    taskfile: taskfiles/bruno-npm-nvm/Taskfile.yml
```

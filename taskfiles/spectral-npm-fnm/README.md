...
**fnm** to provision Node.js — sibling modules cover pnpm and nvm
(`spectral-pnpm-fnm`, `spectral-npm-nvm`, `spectral-pnpm-nvm`). All tasks work
...
```bash
task --taskfile taskfiles/spectral-npm-fnm/Taskfile.yml lint TARGETS=openapi.yaml
```
...
includes:
  spectral:
    taskfile: taskfiles/spectral-npm-fnm/Taskfile.yml
```

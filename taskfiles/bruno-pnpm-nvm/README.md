# Bruno Taskfile (pnpm-nvm) Public Tasks
...
dev dependency This variant uses the `pnpm-nvm` stack (`pnpm-nvm`) package manager.
...
includes:
  pnpm:
    taskfile: taskfiles/pnpm-nvm/Taskfile.yml
  bruno:
    taskfile: taskfiles/bruno-pnpm-nvm/Taskfile.yml
```

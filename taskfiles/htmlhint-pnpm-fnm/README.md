...
(`htmlhint-npm-fnm`, `htmlhint-npm-nvm`, `htmlhint-pnpm-nvm`). All tasks work
...
```bash
task --taskfile taskfiles/htmlhint-pnpm-fnm/Taskfile.yml lint TARGETS="src/**/*.html"
```
...
includes:
  htmlhint:
    taskfile: taskfiles/htmlhint-pnpm-fnm/Taskfile.yml
```

# Bruno Taskfile (yarn-fnm) Public Tasks
...
dev dependency This variant uses the `yarn-fnm` stack (`yarn-fnm`) package manager.
...
includes:
  ...
  bruno:
    taskfile: taskfiles/bruno-yarn-fnm/Taskfile.yml
```

# Bruno Taskfile (yarn-nvm) Public Tasks
...
dev dependency This variant uses the `yarn-nvm` stack (`yarn-nvm`) package manager.
...
includes:
  ...
  bruno:
    taskfile: taskfiles/bruno-yarn-nvm/Taskfile.yml
```

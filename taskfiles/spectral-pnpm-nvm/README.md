...
(`spectral-npm-fnm`, `spectral-pnpm-fnm`, `spectral-npm-nvm`). All tasks work
...
```bash
task --taskfile taskfiles/spectral-pnpm-nvm/Taskfile.yml lint TARGETS=openapi.yaml
```
...
includes:
  spectral:
    taskfile: taskfiles/spectral-pnpm-nvm/Taskfile.yml
```

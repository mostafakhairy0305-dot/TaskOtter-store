# Corepack Taskfile (nvm) Public Tasks

Corepack keeps Yarn and pnpm versions tied to a project's `packageManager`
field and can provide package manager shims for the nvm-managed Node.js runtime.
Corepack itself may need installation on Node.js releases that do not bundle it.

This Taskfile requires the **nvm stack**. Include it alongside `nvm` in your root
Taskfile:
